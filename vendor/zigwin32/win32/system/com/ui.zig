...
pub const IThumbnailExtractor = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn ExtractThumbnail(self: *const IThumbnailExtractor, pStg: ?*IStorage, ulLength: u32, ulHeight: u32, pulOutputLength: ?*u32, pulOutputHeight: ?*u32, phOutputBitmap: ?*?HBITMAP) HRESULT {
        return self.vtable.ExtractThumbnail(self, pStg, ulLength, ulHeight, pulOutputLength, pulOutputHeight, phOutputBitmap);
    }
    pub fn OnFileUpdated(self: *const IThumbnailExtractor, pStg: ?*IStorage) HRESULT {
...
pub const IDummyHICONIncluder = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Dummy(self: *const IDummyHICONIncluder, h1: ?HICON, h2: ?HDC) HRESULT {
