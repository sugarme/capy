...
pub const ISurfaceImageSourceNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn SetDevice(self: *const ISurfaceImageSourceNative, device: ?*IDXGIDevice) HRESULT {
        return self.vtable.SetDevice(self, device);
    }
    pub fn BeginDraw(self: *const ISurfaceImageSourceNative, updateRect: RECT, surface: ?*?*IDXGISurface, offset: ?*POINT) HRESULT {
        return self.vtable.BeginDraw(self, updateRect, surface, offset);
    }
    pub fn EndDraw(self: *const ISurfaceImageSourceNative) HRESULT {
...
pub const IVirtualSurfaceUpdatesCallbackNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn UpdatesNeeded(self: *const IVirtualSurfaceUpdatesCallbackNative) HRESULT {
...
pub const IVirtualSurfaceImageSourceNative = extern union {
    ...
    IUnknown: IUnknown,
    pub fn Invalidate(self: *const IVirtualSurfaceImageSourceNative, updateRect: RECT) HRESULT {
        return self.vtable.Invalidate(self, updateRect);
    }
    pub fn GetUpdateRectCount(self: *const IVirtualSurfaceImageSourceNative, count: ?*u32) HRESULT {
        return self.vtable.GetUpdateRectCount(self, count);
    }
    pub fn GetUpdateRects(self: *const IVirtualSurfaceImageSourceNative, updates: [*]RECT, count: u32) HRESULT {
        return self.vtable.GetUpdateRects(self, updates, count);
    }
    pub fn GetVisibleBounds(self: *const IVirtualSurfaceImageSourceNative, bounds: ?*RECT) HRESULT {
        return self.vtable.GetVisibleBounds(self, bounds);
    }
    pub fn RegisterForUpdatesNeeded(self: *const IVirtualSurfaceImageSourceNative, callback: ?*IVirtualSurfaceUpdatesCallbackNative) HRESULT {
        return self.vtable.RegisterForUpdatesNeeded(self, callback);
    }
    pub fn Resize(self: *const IVirtualSurfaceImageSourceNative, newWidth: i32, newHeight: i32) HRESULT {
...
pub const ISwapChainBackgroundPanelNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn SetSwapChain(self: *const ISwapChainBackgroundPanelNative, swapChain: ?*IDXGISwapChain) HRESULT {
...
pub const ISurfaceImageSourceManagerNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn FlushAllSurfacesWithDevice(self: *const ISurfaceImageSourceManagerNative, device: ?*IUnknown) HRESULT {
...
pub const ISurfaceImageSourceNativeWithD2D = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn SetDevice(self: *const ISurfaceImageSourceNativeWithD2D, device: ?*IUnknown) HRESULT {
        return self.vtable.SetDevice(self, device);
    }
    pub fn BeginDraw(self: *const ISurfaceImageSourceNativeWithD2D, updateRect: ?*const RECT, iid: ?*const Guid, updateObject: **anyopaque, offset: ?*POINT) HRESULT {
        return self.vtable.BeginDraw(self, updateRect, iid, updateObject, offset);
    }
    pub fn EndDraw(self: *const ISurfaceImageSourceNativeWithD2D) HRESULT {
        return self.vtable.EndDraw(self);
    }
    pub fn SuspendDraw(self: *const ISurfaceImageSourceNativeWithD2D) HRESULT {
        return self.vtable.SuspendDraw(self);
    }
    pub fn ResumeDraw(self: *const ISurfaceImageSourceNativeWithD2D) HRESULT {
...
pub const ISwapChainPanelNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn SetSwapChain(self: *const ISwapChainPanelNative, swapChain: ?*IDXGISwapChain) HRESULT {
        return self.vtable.SetSwapChain(self, swapChain);
    }
};
...
pub const ISwapChainPanelNative2 = extern union {
    ...
    IUnknown: IUnknown,
    pub fn SetSwapChainHandle(self: *const ISwapChainPanelNative2, swapChainHandle: ?HANDLE) HRESULT {
...
pub const IDesktopWindowXamlSourceNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn AttachToWindow(self: *const IDesktopWindowXamlSourceNative, parentWnd: ?HWND) HRESULT {
        return self.vtable.AttachToWindow(self, parentWnd);
    }
    pub fn get_WindowHandle(self: *const IDesktopWindowXamlSourceNative, hWnd: ?*?HWND) HRESULT {
...
pub const IDesktopWindowXamlSourceNative2 = extern union {
    ...
    IUnknown: IUnknown,
    pub fn PreTranslateMessage(self: *const IDesktopWindowXamlSourceNative2, message: ?*const MSG, result: ?*BOOL) HRESULT {
...
pub const IReferenceTrackerTarget = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn AddRefFromReferenceTracker(self: *const IReferenceTrackerTarget) u32 {
        return self.vtable.AddRefFromReferenceTracker(self);
    }
    pub fn ReleaseFromReferenceTracker(self: *const IReferenceTrackerTarget) u32 {
        return self.vtable.ReleaseFromReferenceTracker(self);
    }
    pub fn Peg(self: *const IReferenceTrackerTarget) HRESULT {
        return self.vtable.Peg(self);
    }
    pub fn Unpeg(self: *const IReferenceTrackerTarget) HRESULT {
...
pub const IReferenceTracker = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn ConnectFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.ConnectFromTrackerSource(self);
    }
    pub fn DisconnectFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.DisconnectFromTrackerSource(self);
    }
    pub fn FindTrackerTargets(self: *const IReferenceTracker, callback: ?*IFindReferenceTargetsCallback) HRESULT {
        return self.vtable.FindTrackerTargets(self, callback);
    }
    pub fn GetReferenceTrackerManager(self: *const IReferenceTracker, value: ?*?*IReferenceTrackerManager) HRESULT {
        return self.vtable.GetReferenceTrackerManager(self, value);
    }
    pub fn AddRefFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.AddRefFromTrackerSource(self);
    }
    pub fn ReleaseFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.ReleaseFromTrackerSource(self);
    }
    pub fn PegFromTrackerSource(self: *const IReferenceTracker) HRESULT {
...
pub const IReferenceTrackerManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn ReferenceTrackingStarted(self: *const IReferenceTrackerManager) HRESULT {
        return self.vtable.ReferenceTrackingStarted(self);
    }
    pub fn FindTrackerTargetsCompleted(self: *const IReferenceTrackerManager, findFailed: u8) HRESULT {
        return self.vtable.FindTrackerTargetsCompleted(self, findFailed);
    }
    pub fn ReferenceTrackingCompleted(self: *const IReferenceTrackerManager) HRESULT {
        return self.vtable.ReferenceTrackingCompleted(self);
    }
    pub fn SetReferenceTrackerHost(self: *const IReferenceTrackerManager, value: ?*IReferenceTrackerHost) HRESULT {
...
pub const IFindReferenceTargetsCallback = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn FoundTrackerTarget(self: *const IFindReferenceTargetsCallback, target: ?*IReferenceTrackerTarget) HRESULT {
...
pub const IReferenceTrackerHost = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn DisconnectUnusedReferenceSources(self: *const IReferenceTrackerHost, options: XAML_REFERENCETRACKER_DISCONNECT) HRESULT {
        return self.vtable.DisconnectUnusedReferenceSources(self, options);
    }
    pub fn ReleaseDisconnectedReferenceSources(self: *const IReferenceTrackerHost) HRESULT {
        return self.vtable.ReleaseDisconnectedReferenceSources(self);
    }
    pub fn NotifyEndOfReferenceTrackingOnThread(self: *const IReferenceTrackerHost) HRESULT {
        return self.vtable.NotifyEndOfReferenceTrackingOnThread(self);
    }
    pub fn GetTrackerTarget(self: *const IReferenceTrackerHost, unknown: ?*IUnknown, newReference: ?*?*IReferenceTrackerTarget) HRESULT {
        return self.vtable.GetTrackerTarget(self, unknown, newReference);
    }
    pub fn AddMemoryPressure(self: *const IReferenceTrackerHost, bytesAllocated: u64) HRESULT {
        return self.vtable.AddMemoryPressure(self, bytesAllocated);
    }
    pub fn RemoveMemoryPressure(self: *const IReferenceTrackerHost, bytesAllocated: u64) HRESULT {
...
pub const ITrackerOwner = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn CreateTrackerHandle(self: *const ITrackerOwner, returnValue: ?*?*TrackerHandle__) HRESULT {
        return self.vtable.CreateTrackerHandle(self, returnValue);
    }
    pub fn DeleteTrackerHandle(self: *const ITrackerOwner, handle: ?*TrackerHandle__) HRESULT {
        return self.vtable.DeleteTrackerHandle(self, handle);
    }
    pub fn SetTrackerValue(self: *const ITrackerOwner, handle: ?*TrackerHandle__, value: ?*IUnknown) HRESULT {
        return self.vtable.SetTrackerValue(self, handle, value);
    }
    pub fn TryGetSafeTrackerValue(self: *const ITrackerOwner, handle: ?*TrackerHandle__, returnValue: ?*?*IUnknown) u8 {
