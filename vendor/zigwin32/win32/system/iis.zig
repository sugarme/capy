...
pub const IFtpProviderConstruct = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Construct(self: *const IFtpProviderConstruct, configurationEntries: ?*SAFEARRAY) HRESULT {
...
pub const IFtpAuthenticationProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn AuthenticateUser(self: *const IFtpAuthenticationProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszUserName: ?[*:0]const u16, pszPassword: ?[*:0]const u16, ppszCanonicalUserName: ?*?PWSTR, pfAuthenticated: ?*BOOL) HRESULT {
...
pub const AsyncIFtpAuthenticationProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_AuthenticateUser(self: *const AsyncIFtpAuthenticationProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszUserName: ?[*:0]const u16, pszPassword: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_AuthenticateUser(self, pszSessionId, pszSiteName, pszUserName, pszPassword);
    }
    pub fn Finish_AuthenticateUser(self: *const AsyncIFtpAuthenticationProvider, ppszCanonicalUserName: ?*?PWSTR, pfAuthenticated: ?*BOOL) HRESULT {
...
pub const IFtpRoleProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn IsUserInRole(self: *const IFtpRoleProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszUserName: ?[*:0]const u16, pszRole: ?[*:0]const u16, pfIsInRole: ?*BOOL) HRESULT {
...
pub const AsyncIFtpRoleProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_IsUserInRole(self: *const AsyncIFtpRoleProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszUserName: ?[*:0]const u16, pszRole: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_IsUserInRole(self, pszSessionId, pszSiteName, pszUserName, pszRole);
    }
    pub fn Finish_IsUserInRole(self: *const AsyncIFtpRoleProvider, pfIsInRole: ?*BOOL) HRESULT {
...
pub const IFtpHomeDirectoryProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn GetUserHomeDirectoryData(self: *const IFtpHomeDirectoryProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszUserName: ?[*:0]const u16, ppszHomeDirectoryData: ?*?PWSTR) HRESULT {
...
pub const AsyncIFtpHomeDirectoryProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_GetUserHomeDirectoryData(self: *const AsyncIFtpHomeDirectoryProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszUserName: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_GetUserHomeDirectoryData(self, pszSessionId, pszSiteName, pszUserName);
    }
    pub fn Finish_GetUserHomeDirectoryData(self: *const AsyncIFtpHomeDirectoryProvider, ppszHomeDirectoryData: ?*?PWSTR) HRESULT {
...
pub const IFtpLogProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Log(self: *const IFtpLogProvider, pLoggingParameters: ?*const LOGGING_PARAMETERS) HRESULT {
...
pub const AsyncIFtpLogProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_Log(self: *const AsyncIFtpLogProvider, pLoggingParameters: ?*const LOGGING_PARAMETERS) HRESULT {
        return self.vtable.Begin_Log(self, pLoggingParameters);
    }
    pub fn Finish_Log(self: *const AsyncIFtpLogProvider) HRESULT {
...
pub const IFtpAuthorizationProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn GetUserAccessPermission(self: *const IFtpAuthorizationProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszVirtualPath: ?[*:0]const u16, pszUserName: ?[*:0]const u16, pFtpAccess: ?*FTP_ACCESS) HRESULT {
...
pub const AsyncIFtpAuthorizationProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_GetUserAccessPermission(self: *const AsyncIFtpAuthorizationProvider, pszSessionId: ?[*:0]const u16, pszSiteName: ?[*:0]const u16, pszVirtualPath: ?[*:0]const u16, pszUserName: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_GetUserAccessPermission(self, pszSessionId, pszSiteName, pszVirtualPath, pszUserName);
    }
    pub fn Finish_GetUserAccessPermission(self: *const AsyncIFtpAuthorizationProvider, pFtpAccess: ?*FTP_ACCESS) HRESULT {
...
pub const IFtpPreprocessProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn HandlePreprocess(self: *const IFtpPreprocessProvider, pPreProcessParameters: ?*const PRE_PROCESS_PARAMETERS, pFtpProcessStatus: ?*FTP_PROCESS_STATUS) HRESULT {
...
pub const AsyncIFtpPreprocessProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_HandlePreprocess(self: *const AsyncIFtpPreprocessProvider, pPreProcessParameters: ?*const PRE_PROCESS_PARAMETERS) HRESULT {
        return self.vtable.Begin_HandlePreprocess(self, pPreProcessParameters);
    }
    pub fn Finish_HandlePreprocess(self: *const AsyncIFtpPreprocessProvider, pFtpProcessStatus: ?*FTP_PROCESS_STATUS) HRESULT {
...
pub const IFtpPostprocessProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn HandlePostprocess(self: *const IFtpPostprocessProvider, pPostProcessParameters: ?*const POST_PROCESS_PARAMETERS, pFtpProcessStatus: ?*FTP_PROCESS_STATUS) HRESULT {
...
pub const AsyncIFtpPostprocessProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_HandlePostprocess(self: *const AsyncIFtpPostprocessProvider, pPostProcessParameters: ?*const POST_PROCESS_PARAMETERS) HRESULT {
        return self.vtable.Begin_HandlePostprocess(self, pPostProcessParameters);
    }
    pub fn Finish_HandlePostprocess(self: *const AsyncIFtpPostprocessProvider, pFtpProcessStatus: ?*FTP_PROCESS_STATUS) HRESULT {
...
pub const IADMEXT = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Initialize(self: *const IADMEXT) HRESULT {
        return self.vtable.Initialize(self);
    }
    pub fn EnumDcomCLSIDs(self: *const IADMEXT, pclsidDcom: ?*Guid, dwEnumIndex: u32) HRESULT {
        return self.vtable.EnumDcomCLSIDs(self, pclsidDcom, dwEnumIndex);
    }
    pub fn Terminate(self: *const IADMEXT) HRESULT {
...
pub const IMSAdminBaseW = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn AddKey(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16) HRESULT {
        return self.vtable.AddKey(self, hMDHandle, pszMDPath);
    }
    pub fn DeleteKey(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16) HRESULT {
        return self.vtable.DeleteKey(self, hMDHandle, pszMDPath);
    }
    pub fn DeleteChildKeys(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16) HRESULT {
        return self.vtable.DeleteChildKeys(self, hMDHandle, pszMDPath);
    }
    pub fn EnumKeys(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pszMDName: *[256]u16, dwMDEnumObjectIndex: u32) HRESULT {
        return self.vtable.EnumKeys(self, hMDHandle, pszMDPath, pszMDName, dwMDEnumObjectIndex);
    }
    pub fn CopyKey(self: *const IMSAdminBaseW, hMDSourceHandle: u32, pszMDSourcePath: ?[*:0]const u16, hMDDestHandle: u32, pszMDDestPath: ?[*:0]const u16, bMDOverwriteFlag: BOOL, bMDCopyFlag: BOOL) HRESULT {
        return self.vtable.CopyKey(self, hMDSourceHandle, pszMDSourcePath, hMDDestHandle, pszMDDestPath, bMDOverwriteFlag, bMDCopyFlag);
    }
    pub fn RenameKey(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pszMDNewName: ?[*:0]const u16) HRESULT {
        return self.vtable.RenameKey(self, hMDHandle, pszMDPath, pszMDNewName);
    }
    pub fn SetData(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pmdrMDData: ?*METADATA_RECORD) HRESULT {
        return self.vtable.SetData(self, hMDHandle, pszMDPath, pmdrMDData);
    }
    pub fn GetData(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pmdrMDData: ?*METADATA_RECORD, pdwMDRequiredDataLen: ?*u32) HRESULT {
        return self.vtable.GetData(self, hMDHandle, pszMDPath, pmdrMDData, pdwMDRequiredDataLen);
    }
    pub fn DeleteData(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, dwMDIdentifier: u32, dwMDDataType: u32) HRESULT {
        return self.vtable.DeleteData(self, hMDHandle, pszMDPath, dwMDIdentifier, dwMDDataType);
    }
    pub fn EnumData(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pmdrMDData: ?*METADATA_RECORD, dwMDEnumDataIndex: u32, pdwMDRequiredDataLen: ?*u32) HRESULT {
        return self.vtable.EnumData(self, hMDHandle, pszMDPath, pmdrMDData, dwMDEnumDataIndex, pdwMDRequiredDataLen);
    }
    pub fn GetAllData(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, dwMDAttributes: u32, dwMDUserType: u32, dwMDDataType: u32, pdwMDNumDataEntries: ?*u32, pdwMDDataSetNumber: ?*u32, dwMDBufferSize: u32, pbMDBuffer: ?*u8, pdwMDRequiredBufferSize: ?*u32) HRESULT {
    ...
    pub fn DeleteAllData(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, dwMDUserType: u32, dwMDDataType: u32) HRESULT {
        return self.vtable.DeleteAllData(self, hMDHandle, pszMDPath, dwMDUserType, dwMDDataType);
    }
    pub fn CopyData(self: *const IMSAdminBaseW, hMDSourceHandle: u32, pszMDSourcePath: ?[*:0]const u16, hMDDestHandle: u32, pszMDDestPath: ?[*:0]const u16, dwMDAttributes: u32, dwMDUserType: u32, dwMDDataType: u32, bMDCopyFlag: BOOL) HRESULT {
    ...
    pub fn GetDataPaths(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, dwMDIdentifier: u32, dwMDDataType: u32, dwMDBufferSize: u32, pszBuffer: [*:0]u16, pdwMDRequiredBufferSize: ?*u32) HRESULT {
    ...
    pub fn OpenKey(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, dwMDAccessRequested: u32, dwMDTimeOut: u32, phMDNewHandle: ?*u32) HRESULT {
        return self.vtable.OpenKey(self, hMDHandle, pszMDPath, dwMDAccessRequested, dwMDTimeOut, phMDNewHandle);
    }
    pub fn CloseKey(self: *const IMSAdminBaseW, hMDHandle: u32) HRESULT {
        return self.vtable.CloseKey(self, hMDHandle);
    }
    pub fn ChangePermissions(self: *const IMSAdminBaseW, hMDHandle: u32, dwMDTimeOut: u32, dwMDAccessRequested: u32) HRESULT {
        return self.vtable.ChangePermissions(self, hMDHandle, dwMDTimeOut, dwMDAccessRequested);
    }
    pub fn SaveData(self: *const IMSAdminBaseW) HRESULT {
        return self.vtable.SaveData(self);
    }
    pub fn GetHandleInfo(self: *const IMSAdminBaseW, hMDHandle: u32, pmdhiInfo: ?*METADATA_HANDLE_INFO) HRESULT {
        return self.vtable.GetHandleInfo(self, hMDHandle, pmdhiInfo);
    }
    pub fn GetSystemChangeNumber(self: *const IMSAdminBaseW, pdwSystemChangeNumber: ?*u32) HRESULT {
        return self.vtable.GetSystemChangeNumber(self, pdwSystemChangeNumber);
    }
    pub fn GetDataSetNumber(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pdwMDDataSetNumber: ?*u32) HRESULT {
        return self.vtable.GetDataSetNumber(self, hMDHandle, pszMDPath, pdwMDDataSetNumber);
    }
    pub fn SetLastChangeTime(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pftMDLastChangeTime: ?*FILETIME, bLocalTime: BOOL) HRESULT {
        return self.vtable.SetLastChangeTime(self, hMDHandle, pszMDPath, pftMDLastChangeTime, bLocalTime);
    }
    pub fn GetLastChangeTime(self: *const IMSAdminBaseW, hMDHandle: u32, pszMDPath: ?[*:0]const u16, pftMDLastChangeTime: ?*FILETIME, bLocalTime: BOOL) HRESULT {
        return self.vtable.GetLastChangeTime(self, hMDHandle, pszMDPath, pftMDLastChangeTime, bLocalTime);
    }
    pub fn KeyExchangePhase1(self: *const IMSAdminBaseW) HRESULT {
        return self.vtable.KeyExchangePhase1(self);
    }
    pub fn KeyExchangePhase2(self: *const IMSAdminBaseW) HRESULT {
        return self.vtable.KeyExchangePhase2(self);
    }
    pub fn Backup(self: *const IMSAdminBaseW, pszMDBackupLocation: ?[*:0]const u16, dwMDVersion: u32, dwMDFlags: u32) HRESULT {
        return self.vtable.Backup(self, pszMDBackupLocation, dwMDVersion, dwMDFlags);
    }
    pub fn Restore(self: *const IMSAdminBaseW, pszMDBackupLocation: ?[*:0]const u16, dwMDVersion: u32, dwMDFlags: u32) HRESULT {
        return self.vtable.Restore(self, pszMDBackupLocation, dwMDVersion, dwMDFlags);
    }
    pub fn EnumBackups(self: *const IMSAdminBaseW, pszMDBackupLocation: *[256]u16, pdwMDVersion: ?*u32, pftMDBackupTime: ?*FILETIME, dwMDEnumIndex: u32) HRESULT {
        return self.vtable.EnumBackups(self, pszMDBackupLocation, pdwMDVersion, pftMDBackupTime, dwMDEnumIndex);
    }
    pub fn DeleteBackup(self: *const IMSAdminBaseW, pszMDBackupLocation: ?[*:0]const u16, dwMDVersion: u32) HRESULT {
        return self.vtable.DeleteBackup(self, pszMDBackupLocation, dwMDVersion);
    }
    pub fn UnmarshalInterface(self: *const IMSAdminBaseW, piadmbwInterface: ?*?*IMSAdminBaseW) HRESULT {
        return self.vtable.UnmarshalInterface(self, piadmbwInterface);
    }
    pub fn GetServerGuid(self: *const IMSAdminBaseW) HRESULT {
...
pub const IMSAdminBase2W = extern union {
    ...
    IUnknown: IUnknown,
    pub fn BackupWithPasswd(self: *const IMSAdminBase2W, pszMDBackupLocation: ?[*:0]const u16, dwMDVersion: u32, dwMDFlags: u32, pszPasswd: ?[*:0]const u16) HRESULT {
        return self.vtable.BackupWithPasswd(self, pszMDBackupLocation, dwMDVersion, dwMDFlags, pszPasswd);
    }
    pub fn RestoreWithPasswd(self: *const IMSAdminBase2W, pszMDBackupLocation: ?[*:0]const u16, dwMDVersion: u32, dwMDFlags: u32, pszPasswd: ?[*:0]const u16) HRESULT {
        return self.vtable.RestoreWithPasswd(self, pszMDBackupLocation, dwMDVersion, dwMDFlags, pszPasswd);
    }
    pub fn Export(self: *const IMSAdminBase2W, pszPasswd: ?[*:0]const u16, pszFileName: ?[*:0]const u16, pszSourcePath: ?[*:0]const u16, dwMDFlags: u32) HRESULT {
        return self.vtable.Export(self, pszPasswd, pszFileName, pszSourcePath, dwMDFlags);
    }
    pub fn Import(self: *const IMSAdminBase2W, pszPasswd: ?[*:0]const u16, pszFileName: ?[*:0]const u16, pszSourcePath: ?[*:0]const u16, pszDestPath: ?[*:0]const u16, dwMDFlags: u32) HRESULT {
        return self.vtable.Import(self, pszPasswd, pszFileName, pszSourcePath, pszDestPath, dwMDFlags);
    }
    pub fn RestoreHistory(self: *const IMSAdminBase2W, pszMDHistoryLocation: ?[*:0]const u16, dwMDMajorVersion: u32, dwMDMinorVersion: u32, dwMDFlags: u32) HRESULT {
        return self.vtable.RestoreHistory(self, pszMDHistoryLocation, dwMDMajorVersion, dwMDMinorVersion, dwMDFlags);
    }
    pub fn EnumHistory(self: *const IMSAdminBase2W, pszMDHistoryLocation: *[256]u16, pdwMDMajorVersion: ?*u32, pdwMDMinorVersion: ?*u32, pftMDHistoryTime: ?*FILETIME, dwMDEnumIndex: u32) HRESULT {
...
pub const IMSAdminBase3W = extern union {
    ...
    IMSAdminBaseW: IMSAdminBaseW,
    IUnknown: IUnknown,
    pub fn GetChildPaths(self: *const IMSAdminBase3W, hMDHandle: u32, pszMDPath: ?[*:0]const u16, cchMDBufferSize: u32, pszBuffer: ?[*:0]u16, pcchMDRequiredBufferSize: ?*u32) HRESULT {
...
pub const IMSImpExpHelpW = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn EnumeratePathsInFile(self: *const IMSImpExpHelpW, pszFileName: ?[*:0]const u16, pszKeyType: ?[*:0]const u16, dwMDBufferSize: u32, pszBuffer: ?[*:0]u16, pdwMDRequiredBufferSize: ?*u32) HRESULT {
...
pub const IMSAdminBaseSinkW = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn SinkNotify(self: *const IMSAdminBaseSinkW, dwMDNumElements: u32, pcoChangeList: [*]MD_CHANGE_OBJECT_W) HRESULT {
        return self.vtable.SinkNotify(self, dwMDNumElements, pcoChangeList);
    }
    pub fn ShutdownNotify(self: *const IMSAdminBaseSinkW) HRESULT {
...
pub const AsyncIMSAdminBaseSinkW = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Begin_SinkNotify(self: *const AsyncIMSAdminBaseSinkW, dwMDNumElements: u32, pcoChangeList: [*]MD_CHANGE_OBJECT_W) HRESULT {
        return self.vtable.Begin_SinkNotify(self, dwMDNumElements, pcoChangeList);
    }
    pub fn Finish_SinkNotify(self: *const AsyncIMSAdminBaseSinkW) HRESULT {
        return self.vtable.Finish_SinkNotify(self);
    }
    pub fn Begin_ShutdownNotify(self: *const AsyncIMSAdminBaseSinkW) HRESULT {
        return self.vtable.Begin_ShutdownNotify(self);
    }
    pub fn Finish_ShutdownNotify(self: *const AsyncIMSAdminBaseSinkW) HRESULT {
