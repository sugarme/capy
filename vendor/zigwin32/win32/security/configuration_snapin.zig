...
pub const ISceSvcAttachmentPersistInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Save(self: *const ISceSvcAttachmentPersistInfo, lpTemplateName: ?*i8, scesvcHandle: ?*?*anyopaque, ppvData: ?*?*anyopaque, pbOverwriteAll: ?*BOOL) HRESULT {
        return self.vtable.Save(self, lpTemplateName, scesvcHandle, ppvData, pbOverwriteAll);
    }
    pub fn IsDirty(self: *const ISceSvcAttachmentPersistInfo, lpTemplateName: ?*i8) HRESULT {
        return self.vtable.IsDirty(self, lpTemplateName);
    }
    pub fn FreeBuffer(self: *const ISceSvcAttachmentPersistInfo, pvData: ?*anyopaque) HRESULT {
...
pub const ISceSvcAttachmentData = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn GetData(self: *const ISceSvcAttachmentData, scesvcHandle: ?*anyopaque, sceType: SCESVC_INFO_TYPE, ppvData: ?*?*anyopaque, psceEnumHandle: ?*u32) HRESULT {
        return self.vtable.GetData(self, scesvcHandle, sceType, ppvData, psceEnumHandle);
    }
    pub fn Initialize(self: *const ISceSvcAttachmentData, lpServiceName: ?*i8, lpTemplateName: ?*i8, lpSceSvcPersistInfo: ?*ISceSvcAttachmentPersistInfo, pscesvcHandle: ?*?*anyopaque) HRESULT {
        return self.vtable.Initialize(self, lpServiceName, lpTemplateName, lpSceSvcPersistInfo, pscesvcHandle);
    }
    pub fn FreeBuffer(self: *const ISceSvcAttachmentData, pvData: ?*anyopaque) HRESULT {
        return self.vtable.FreeBuffer(self, pvData);
    }
    pub fn CloseHandle(self: *const ISceSvcAttachmentData, scesvcHandle: ?*anyopaque) HRESULT {
