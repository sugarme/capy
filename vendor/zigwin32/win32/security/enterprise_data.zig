...
pub const IProtectionPolicyManagerInterop = extern union {
    ...
    IUnknown: IUnknown,
    pub fn RequestAccessForWindowAsync(self: *const IProtectionPolicyManagerInterop, appWindow: ?HWND, sourceIdentity: ?HSTRING, targetIdentity: ?HSTRING, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
        return self.vtable.RequestAccessForWindowAsync(self, appWindow, sourceIdentity, targetIdentity, riid, asyncOperation);
    }
    pub fn GetForWindow(self: *const IProtectionPolicyManagerInterop, appWindow: ?HWND, riid: ?*const Guid, result: **anyopaque) HRESULT {
...
pub const IProtectionPolicyManagerInterop2 = extern union {
    ...
    IInspectable: IInspectable,
    IUnknown: IUnknown,
    pub fn RequestAccessForAppWithWindowAsync(self: *const IProtectionPolicyManagerInterop2, appWindow: ?HWND, sourceIdentity: ?HSTRING, appPackageFamilyName: ?HSTRING, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessWithAuditingInfoForWindowAsync(self: *const IProtectionPolicyManagerInterop2, appWindow: ?HWND, sourceIdentity: ?HSTRING, targetIdentity: ?HSTRING, auditInfoUnk: ?*IUnknown, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessWithMessageForWindowAsync(self: *const IProtectionPolicyManagerInterop2, appWindow: ?HWND, sourceIdentity: ?HSTRING, targetIdentity: ?HSTRING, auditInfoUnk: ?*IUnknown, messageFromApp: ?HSTRING, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessForAppWithAuditingInfoForWindowAsync(self: *const IProtectionPolicyManagerInterop2, appWindow: ?HWND, sourceIdentity: ?HSTRING, appPackageFamilyName: ?HSTRING, auditInfoUnk: ?*IUnknown, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessForAppWithMessageForWindowAsync(self: *const IProtectionPolicyManagerInterop2, appWindow: ?HWND, sourceIdentity: ?HSTRING, appPackageFamilyName: ?HSTRING, auditInfoUnk: ?*IUnknown, messageFromApp: ?HSTRING, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
...
pub const IProtectionPolicyManagerInterop3 = extern union {
    ...
    IInspectable: IInspectable,
    IUnknown: IUnknown,
    pub fn RequestAccessWithBehaviorForWindowAsync(self: *const IProtectionPolicyManagerInterop3, appWindow: ?HWND, sourceIdentity: ?HSTRING, targetIdentity: ?HSTRING, auditInfoUnk: ?*IUnknown, messageFromApp: ?HSTRING, behavior: u32, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessForAppWithBehaviorForWindowAsync(self: *const IProtectionPolicyManagerInterop3, appWindow: ?HWND, sourceIdentity: ?HSTRING, appPackageFamilyName: ?HSTRING, auditInfoUnk: ?*IUnknown, messageFromApp: ?HSTRING, behavior: u32, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessToFilesForAppForWindowAsync(self: *const IProtectionPolicyManagerInterop3, appWindow: ?HWND, sourceItemListUnk: ?*IUnknown, appPackageFamilyName: ?HSTRING, auditInfoUnk: ?*IUnknown, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessToFilesForAppWithMessageAndBehaviorForWindowAsync(self: *const IProtectionPolicyManagerInterop3, appWindow: ?HWND, sourceItemListUnk: ?*IUnknown, appPackageFamilyName: ?HSTRING, auditInfoUnk: ?*IUnknown, messageFromApp: ?HSTRING, behavior: u32, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessToFilesForProcessForWindowAsync(self: *const IProtectionPolicyManagerInterop3, appWindow: ?HWND, sourceItemListUnk: ?*IUnknown, processId: u32, auditInfoUnk: ?*IUnknown, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
    ...
    pub fn RequestAccessToFilesForProcessWithMessageAndBehaviorForWindowAsync(self: *const IProtectionPolicyManagerInterop3, appWindow: ?HWND, sourceItemListUnk: ?*IUnknown, processId: u32, auditInfoUnk: ?*IUnknown, messageFromApp: ?HSTRING, behavior: u32, riid: ?*const Guid, asyncOperation: **anyopaque) HRESULT {
