...
pub const ITpmVirtualSmartCardManagerStatusCallback = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn ReportProgress(self: *const ITpmVirtualSmartCardManagerStatusCallback, Status: TPMVSCMGR_STATUS) HRESULT {
        return self.vtable.ReportProgress(self, Status);
    }
    pub fn ReportError(self: *const ITpmVirtualSmartCardManagerStatusCallback, Error: TPMVSCMGR_ERROR) HRESULT {
...
pub const ITpmVirtualSmartCardManager = extern union {
    ...
    pub fn DestroyVirtualSmartCard(self: *const ITpmVirtualSmartCardManager, pszInstanceId: ?[*:0]const u16, pStatusCallback: ?*ITpmVirtualSmartCardManagerStatusCallback, pfNeedReboot: ?*BOOL) HRESULT {
