...
pub const IIsolatedAppLauncher = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn Launch(self: *const IIsolatedAppLauncher, appUserModelId: ?[*:0]const u16, arguments: ?[*:0]const u16, telemetryParameters: ?*const IsolatedAppLauncherTelemetryParameters) HRESULT {
