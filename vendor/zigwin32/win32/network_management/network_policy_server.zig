...
pub const ISdoMachine = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub fn Attach(self: *const ISdoMachine, bstrComputerName: ?BSTR) HRESULT {
        return self.vtable.Attach(self, bstrComputerName);
    }
    pub fn GetDictionarySDO(self: *const ISdoMachine, ppDictionarySDO: ?*?*IUnknown) HRESULT {
        return self.vtable.GetDictionarySDO(self, ppDictionarySDO);
    }
    pub fn GetServiceSDO(self: *const ISdoMachine, eDataStore: IASDATASTORE, bstrServiceName: ?BSTR, ppServiceSDO: ?*?*IUnknown) HRESULT {
        return self.vtable.GetServiceSDO(self, eDataStore, bstrServiceName, ppServiceSDO);
    }
    pub fn GetUserSDO(self: *const ISdoMachine, eDataStore: IASDATASTORE, bstrUserName: ?BSTR, ppUserSDO: ?*?*IUnknown) HRESULT {
        return self.vtable.GetUserSDO(self, eDataStore, bstrUserName, ppUserSDO);
    }
    pub fn GetOSType(self: *const ISdoMachine, eOSType: ?*IASOSTYPE) HRESULT {
        return self.vtable.GetOSType(self, eOSType);
    }
    pub fn GetDomainType(self: *const ISdoMachine, eDomainType: ?*IASDOMAINTYPE) HRESULT {
        return self.vtable.GetDomainType(self, eDomainType);
    }
    pub fn IsDirectoryAvailable(self: *const ISdoMachine, boolDirectoryAvailable: ?*i16) HRESULT {
        return self.vtable.IsDirectoryAvailable(self, boolDirectoryAvailable);
    }
    pub fn GetAttachedComputer(self: *const ISdoMachine, bstrComputerName: ?*?BSTR) HRESULT {
        return self.vtable.GetAttachedComputer(self, bstrComputerName);
    }
    pub fn GetSDOSchema(self: *const ISdoMachine, ppSDOSchema: ?*?*IUnknown) HRESULT {
...
pub const ISdoMachine2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub fn GetTemplatesSDO(self: *const ISdoMachine2, bstrServiceName: ?BSTR, ppTemplatesSDO: ?*?*IUnknown) HRESULT {
        return self.vtable.GetTemplatesSDO(self, bstrServiceName, ppTemplatesSDO);
    }
    pub fn EnableTemplates(self: *const ISdoMachine2) HRESULT {
        return self.vtable.EnableTemplates(self);
    }
    pub fn SyncConfigAgainstTemplates(self: *const ISdoMachine2, bstrServiceName: ?BSTR, ppConfigRoot: ?*?*IUnknown, ppTemplatesRoot: ?*?*IUnknown, bForcedSync: i16) HRESULT {
        return self.vtable.SyncConfigAgainstTemplates(self, bstrServiceName, ppConfigRoot, ppTemplatesRoot, bForcedSync);
    }
    pub fn ImportRemoteTemplates(self: *const ISdoMachine2, pLocalTemplatesRoot: ?*IUnknown, bstrRemoteMachineName: ?BSTR) HRESULT {
        return self.vtable.ImportRemoteTemplates(self, pLocalTemplatesRoot, bstrRemoteMachineName);
    }
    pub fn Reload(self: *const ISdoMachine2) HRESULT {
...
pub const ISdoServiceControl = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub fn StartService(self: *const ISdoServiceControl) HRESULT {
        return self.vtable.StartService(self);
    }
    pub fn StopService(self: *const ISdoServiceControl) HRESULT {
        return self.vtable.StopService(self);
    }
    pub fn GetServiceStatus(self: *const ISdoServiceControl, status: ?*i32) HRESULT {
        return self.vtable.GetServiceStatus(self, status);
    }
    pub fn ResetService(self: *const ISdoServiceControl) HRESULT {
...
pub const ISdo = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub fn GetPropertyInfo(self: *const ISdo, Id: i32, ppPropertyInfo: ?*?*IUnknown) HRESULT {
        return self.vtable.GetPropertyInfo(self, Id, ppPropertyInfo);
    }
    pub fn GetProperty(self: *const ISdo, Id: i32, pValue: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, Id, pValue);
    }
    pub fn PutProperty(self: *const ISdo, Id: i32, pValue: ?*VARIANT) HRESULT {
        return self.vtable.PutProperty(self, Id, pValue);
    }
    pub fn ResetProperty(self: *const ISdo, Id: i32) HRESULT {
        return self.vtable.ResetProperty(self, Id);
    }
    pub fn Apply(self: *const ISdo) HRESULT {
        return self.vtable.Apply(self);
    }
    pub fn Restore(self: *const ISdo) HRESULT {
        return self.vtable.Restore(self);
    }
    pub fn get__NewEnum(self: *const ISdo, ppEnumVARIANT: ?*?*IUnknown) HRESULT {
...
pub const ISdoCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub fn get_Count(self: *const ISdoCollection, pCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pCount);
    }
    pub fn Add(self: *const ISdoCollection, bstrName: ?BSTR, ppItem: ?*?*IDispatch) HRESULT {
        return self.vtable.Add(self, bstrName, ppItem);
    }
    pub fn Remove(self: *const ISdoCollection, pItem: ?*IDispatch) HRESULT {
        return self.vtable.Remove(self, pItem);
    }
    pub fn RemoveAll(self: *const ISdoCollection) HRESULT {
        return self.vtable.RemoveAll(self);
    }
    pub fn Reload(self: *const ISdoCollection) HRESULT {
        return self.vtable.Reload(self);
    }
    pub fn IsNameUnique(self: *const ISdoCollection, bstrName: ?BSTR, pBool: ?*i16) HRESULT {
        return self.vtable.IsNameUnique(self, bstrName, pBool);
    }
    pub fn Item(self: *const ISdoCollection, Name: ?*VARIANT, pItem: ?*?*IDispatch) HRESULT {
        return self.vtable.Item(self, Name, pItem);
    }
    pub fn get__NewEnum(self: *const ISdoCollection, ppEnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumVARIANT);
    }
};
...
pub const ITemplateSdo = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub fn AddToCollection(self: *const ITemplateSdo, bstrName: ?BSTR, pCollection: ?*IDispatch, ppItem: ?*?*IDispatch) HRESULT {
        return self.vtable.AddToCollection(self, bstrName, pCollection, ppItem);
    }
    pub fn AddToSdo(self: *const ITemplateSdo, bstrName: ?BSTR, pSdoTarget: ?*IDispatch, ppItem: ?*?*IDispatch) HRESULT {
        return self.vtable.AddToSdo(self, bstrName, pSdoTarget, ppItem);
    }
    pub fn AddToSdoAsProperty(self: *const ITemplateSdo, pSdoTarget: ?*IDispatch, id: i32) HRESULT {
...
pub const ISdoDictionaryOld = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub fn EnumAttributes(self: *const ISdoDictionaryOld, Id: ?*VARIANT, pValues: ?*VARIANT) HRESULT {
        return self.vtable.EnumAttributes(self, Id, pValues);
    }
    pub fn GetAttributeInfo(self: *const ISdoDictionaryOld, Id: ATTRIBUTEID, pInfoIDs: ?*VARIANT, pInfoValues: ?*VARIANT) HRESULT {
        return self.vtable.GetAttributeInfo(self, Id, pInfoIDs, pInfoValues);
    }
    pub fn EnumAttributeValues(self: *const ISdoDictionaryOld, Id: ATTRIBUTEID, pValueIds: ?*VARIANT, pValuesDesc: ?*VARIANT) HRESULT {
        return self.vtable.EnumAttributeValues(self, Id, pValueIds, pValuesDesc);
    }
    pub fn CreateAttribute(self: *const ISdoDictionaryOld, Id: ATTRIBUTEID, ppAttributeObject: ?*?*IDispatch) HRESULT {
        return self.vtable.CreateAttribute(self, Id, ppAttributeObject);
    }
    pub fn GetAttributeID(self: *const ISdoDictionaryOld, bstrAttributeName: ?BSTR, pId: ?*ATTRIBUTEID) HRESULT {
