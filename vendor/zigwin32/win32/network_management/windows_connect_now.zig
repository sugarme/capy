...
pub const IWCNDevice = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn SetPassword(self: *const IWCNDevice, Type: WCN_PASSWORD_TYPE, dwPasswordLength: u32, pbPassword: [*:0]const u8) HRESULT {
        return self.vtable.SetPassword(self, Type, dwPasswordLength, pbPassword);
    }
    pub fn Connect(self: *const IWCNDevice, pNotify: ?*IWCNConnectNotify) HRESULT {
        return self.vtable.Connect(self, pNotify);
    }
    pub fn GetAttribute(self: *const IWCNDevice, AttributeType: WCN_ATTRIBUTE_TYPE, dwMaxBufferSize: u32, pbBuffer: [*:0]u8, pdwBufferUsed: ?*u32) HRESULT {
        return self.vtable.GetAttribute(self, AttributeType, dwMaxBufferSize, pbBuffer, pdwBufferUsed);
    }
    pub fn GetIntegerAttribute(self: *const IWCNDevice, AttributeType: WCN_ATTRIBUTE_TYPE, puInteger: ?*u32) HRESULT {
        return self.vtable.GetIntegerAttribute(self, AttributeType, puInteger);
    }
    pub fn GetStringAttribute(self: *const IWCNDevice, AttributeType: WCN_ATTRIBUTE_TYPE, cchMaxString: u32, wszString: [*:0]u16) HRESULT {
        return self.vtable.GetStringAttribute(self, AttributeType, cchMaxString, wszString);
    }
    pub fn GetNetworkProfile(self: *const IWCNDevice, cchMaxStringLength: u32, wszProfile: [*:0]u16) HRESULT {
        return self.vtable.GetNetworkProfile(self, cchMaxStringLength, wszProfile);
    }
    pub fn SetNetworkProfile(self: *const IWCNDevice, pszProfileXml: ?[*:0]const u16) HRESULT {
        return self.vtable.SetNetworkProfile(self, pszProfileXml);
    }
    pub fn GetVendorExtension(self: *const IWCNDevice, pVendorExtSpec: ?*const WCN_VENDOR_EXTENSION_SPEC, dwMaxBufferSize: u32, pbBuffer: [*:0]u8, pdwBufferUsed: ?*u32) HRESULT {
        return self.vtable.GetVendorExtension(self, pVendorExtSpec, dwMaxBufferSize, pbBuffer, pdwBufferUsed);
    }
    pub fn SetVendorExtension(self: *const IWCNDevice, pVendorExtSpec: ?*const WCN_VENDOR_EXTENSION_SPEC, cbBuffer: u32, pbBuffer: [*:0]const u8) HRESULT {
        return self.vtable.SetVendorExtension(self, pVendorExtSpec, cbBuffer, pbBuffer);
    }
    pub fn Unadvise(self: *const IWCNDevice) HRESULT {
        return self.vtable.Unadvise(self);
    }
    pub fn SetNFCPasswordParams(self: *const IWCNDevice, Type: WCN_PASSWORD_TYPE, dwOOBPasswordID: u32, dwPasswordLength: u32, pbPassword: ?[*:0]const u8, dwRemotePublicKeyHashLength: u32, pbRemotePublicKeyHash: ?[*:0]const u8, dwDHKeyBlobLength: u32, pbDHKeyBlob: ?[*:0]const u8) HRESULT {
...
pub const IWCNConnectNotify = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub fn ConnectSucceeded(self: *const IWCNConnectNotify) HRESULT {
        return self.vtable.ConnectSucceeded(self);
    }
    pub fn ConnectFailed(self: *const IWCNConnectNotify, hrFailure: HRESULT) HRESULT {
